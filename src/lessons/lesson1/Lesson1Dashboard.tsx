  ...
  return (
    <div>
      ...
      <section style={{ marginBottom: 52 }}>
        ...
        <P>What matters is <strong style={{ color: '#2B2118', fontWeight: 500 }}>Mean Arterial Pressure (MAP)</strong> — the average pressure driving blood forward across the entire cardiac cycle. Your kidneys, brain, and gut receive pulsatile flow generated by cardiac output, and it's that perfusion pressure that keeps them supplied with oxygen and nutrients.</P>
